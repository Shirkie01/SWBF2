...
namespace SWBF2.UnitTests
{
    ...
    public class SerializationTests
    {
        ...
        //{
        //    var di = new DirectoryInfo("assets/worlds");
        //    FileInfo[] fileInfos = di.GetFiles("*.TER", SearchOption.AllDirectories);
        //    foreach (var fi in fileInfos)
        //    {
        //        TerrainDeserializeSerializeTest(fi.FullName);
        //    }
        //}
        ...
        {
            TerrainDeserializeSerializeTest("AAA.TER");
        }
